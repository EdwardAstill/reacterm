/**
 * MarkdownViewer — enhanced Markdown viewer with Table of Contents sidebar.
 *
 * Two-column layout: a navigable TOC sidebar on the left and scrollable
 * rendered Markdown on the right. The TOC is auto-generated from headings
 * found in the content. Keyboard navigation (up/down to move, enter to
 * jump) and active-heading highlighting as the user scrolls are supported.
 *
 * Built on top of the existing Markdown component for rendering and
...
export const MarkdownViewer = React.memo(function MarkdownViewer(
  ...
  ) as unknown as MarkdownViewerProps;
