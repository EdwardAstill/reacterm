#!/usr/bin/env npx tsx
/**
 * Reacterm TUI — Website in Terminal
 *
 * Cinematic demo inspired by the Reacterm website and DevTools page.
 * Each phase has its own color accent and visual centerpiece.
 *
 * Phase 1 (0-4s):   Hero — REACTERM title, tagline, code
 ...
 * Phase 5 (21-24s): End
 *
 * Usage: npx tsx examples/reacterm-website.tsx
 */
...
function Footer({ accent }: { accent: string }) {
  return (
    <Box height={1} flexShrink={0} paddingX={2} flexDirection="row">
      <Text bold color={accent}>{"█◆◆█ reacterm"}</Text>
      <Box flex={1} />
    ...
    return (
      <Box flexDirection="column" width={width} height={height}>
        <Box height={1} paddingX={2} flexDirection="row">
          <Text bold color={C.green}>REACTERM DASHBOARD</Text>
          <Text color={C.dim}>{" "}</Text>
        ...
        <Line w={width} color={C.green + "30"} />
        <Box height={1} paddingX={2} flexDirection="row">
          <Text bold color={C.green}>{"█◆◆█ reacterm"}</Text>
          <Box flex={1} />
  ...
  if (t < 21000) {
    ...
    return (
      <Box flexDirection="column" width={width} height={height}>
        ...
        <Line w={width} color={C.cyan + "30"} />
        <Box height={1} paddingX={2} flexDirection="row">
          <Text bold color={C.cyan}>{"█◆◆█ reacterm agent"}</Text>
          <Box flex={1} />
