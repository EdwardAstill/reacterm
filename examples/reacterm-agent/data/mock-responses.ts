/**
 * Reacterm Agent CLI — Mock response templates.
 *
...
export const RESPONSE_TEMPLATES: ResponseTemplate[] = [
  ...
  // ── Project Overview ─────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      {
        kind: "function_return",
        content: "packages/core/, packages/reacterm/, packages/cli/, docs/, scripts/",
      },
      {
        kind: "response",
        content:
          "Here's your project at a glance:\n\n" +
          "**reacterm** — A monorepo with three main packages:\n\n" +
