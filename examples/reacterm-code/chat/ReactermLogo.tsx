/**
 * ReactermLogo — mini rotating 3D diamond for inline use.
 *
...
interface ReactermLogoProps {
  color?: string;
  interval?: number;
}

export function ReactermLogo({ color = S.arc, interval = 150 }: ReactermLogoProps): React.ReactElement {
