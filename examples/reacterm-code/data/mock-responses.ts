/**
 * Reacterm Code CLI — Mock response templates.
 *
    ...
    steps: [
      ...
      },
      {
        ...
        content:
          ...
          "This is why Reacterm can hit **18K FPS** on synthetic benchmarks — " +
  ...
  // ── Greeting ─────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        kind: "response",
        content:
          "Hey! I'm Reacterm. I've scanned your project — **91 TypeScript files** in `src/`.\n\n" +
    ...
    steps: [
      ...
      },
      {
        ...
        content:
          ...
          "| `reacterm` | Terminal UI framework (cell-diff rendering) | 18K FPS |\n" +
