...
export function ShowcaseRichContent(props) {
    const colors = useColors();
    ...
    heading("Image — Storm Banner"), gap(), React.createElement("tui-box", { key: "img-banner", marginLeft: 2 }, React.createElement(Image, {
        src: imagePath ?? path.join(process.cwd(), "examples", "storm-banner.png"),
        alt: "Storm Banner",
        width: 60,
        height: 10,
        protocol: "block",
    })), gap(), heading("Image — Colorful Bar Chart"), gap(), React.createElement("tui-box", { key: "img-chart", marginLeft: 2 }, React.createElement(Image, {
        src: path.join(process.cwd(), "examples", "chart.png"),
        alt: "Bar Chart",
        width: 60,
        height: 12,
        protocol: "block",
    })), gap(), heading("Image — Sunset Landscape"), gap(), React.createElement("tui-box", { key: "img-sunset", marginLeft: 2 }, React.createElement(Image, {
        src: path.join(process.cwd(), "examples", "sunset.png"),
        alt: "Sunset",
        width: 60,
        height: 15,
        protocol: "block",
    })), gap(), heading("Image — Mountain Scene"), gap(), React.createElement("tui-box", { key: "img-mountain", marginLeft: 2 }, React.createElement(Image, {
    ...
    // 2. Markdown
    heading("MarkdownText"), gap(), React.createElement("tui-box", {
        key: "md-box", marginLeft: 2, marginRight: 2,
    }, React.createElement(MarkdownText, null, MARKDOWN)), gap(), 
    // 3. TypeScript Code
    heading("SyntaxHighlight — TypeScript"), gap(), React.createElement("tui-box", {
    ...
    // 4. Python Code
    heading("SyntaxHighlight — Python"), gap(), React.createElement("tui-box", {
    ...
    React.createElement("tui-text", {
        key: "footer", dim: true,
    }, "  [q] Quit · [↑↓] Scroll · [PgUp/PgDn] Page"), gap());
}
//# sourceMappingURL=ShowcaseRichContent.js.map