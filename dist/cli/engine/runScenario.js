import { renderDriver } from "../../testing/index.js";
import { loadEntry } from "./moduleLoader.js";
import { pollWaitFor } from "./pollWaitFor.js";
export async function runScenarioFromCli(opts) {
    const start = Date.now();
    const element = (await loadEntry(opts.entry, opts.scenario.env ?? {}));
...
async function applyStep(r, step) {
    switch (step.kind) {
        case "press":
