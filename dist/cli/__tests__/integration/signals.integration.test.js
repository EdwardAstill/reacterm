...
const run = (args, signal, afterMs = 1500) => new Promise((res) => {
...
const runDouble = (args, firstAfterMs = 1500, gapMs = 100) => new Promise((res) => {
    const child = spawn("node", [BIN, ...args]);
...
//# sourceMappingURL=signals.integration.test.js.map