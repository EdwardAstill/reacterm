...
export class InputManager {
    ...
    prioritizedKeyListeners = new Set();
    mouseListeners = new Set();
    pasteListeners = new Set();
    warnedMultipleHandlers = false;
    mouseBuffer = "";
    pasteBuffer = null; // non-null = inside paste
    escBuffer = "";
    escTimer = null;
    dataHandler;
    stdin;
    ...
    constructor(stdin = process.stdin) {
        this.stdin = stdin;
        this.dataHandler = (data) => this.handleData(typeof data === "string" ? data : data.toString("utf-8"));
    }
